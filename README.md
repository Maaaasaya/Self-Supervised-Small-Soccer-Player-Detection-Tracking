...
```
cd script/detection
python3 eval_fasterRCNN.py --backbone resnet50 --test_dataset_name TV_soccer --save_visualization --checkpoint ../../checkpoints_runs/player_det_resnet50_teacher.pth
...
```
cd script/detection
python3 eval_fasterRCNN.py --backbone resnet18 --test_dataset_name SPD --save_visualization --checkpoint ../../checkpoints_runs/player_det_resnet18_student.pth
```
...
```
python main_tracking.py --data_name issia --visualize --write_video --output_path ../../results
```
